...
export declare class MerchantsService {
    ...
    requestPayout(userId: string, dto: {
        amount: number;
    ...
    getPayouts(userId: string, query: any): Promise<{
        data: {
            amount: number;
            id: string;
            created_at: Date | null;
    ...
    regenerateQr(userId: string): Promise<{
        data: {
            qr_payload: string;
            qr_image_base64: string;
            qr_image_data_url: string;
    ...
    getMerchantQr(userId: string): Promise<{
        data: {
            qr_payload: string;
            qr_image_base64: string;
            qr_image_data_url: string;
